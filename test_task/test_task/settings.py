...
SECRET_KEY = 'django-insecure-j&v5ed5qf&dxbw9##!j%$n^uif+rhsk8-m2!uq0#v-5ne6wyzl'
...
INSTALLED_APPS = [
    ...
    'residences_place.apps.ResidencesPlaceConfig',
    'human.apps.HumanConfig',
    'human_actions.apps.HumanActionsConfig',
]
